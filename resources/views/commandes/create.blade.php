            ...
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <select name="type" id="type-commande" class="form-select" required>
                        ...
                        <option value="fournisseur" {{ old('type') == 'fournisseur' ? 'selected' : '' }}>
...
<script>
        ...
        tr.innerHTML = `
            ...
            <td>
                <input type="number" name="produits[${id}][quantite]" class="form-control form-control-sm input-quantite"
                       min="1" value="1" required oninput="majTotalLigne(${id})">
            </td>
            <td>
                <input type="number" name="produits[${id}][prix]" class="form-control form-control-sm input-prix"
                       min="0" step="0.01" value="0" required oninput="majTotalLigne(${id})">
            </td>
            <td>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        toggleBlocsTiers();
        ajouterLigne(); // une ligne de départ pour faciliter la saisie
    });
