...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="mb-0">Modifier : {{ $fournisseur->societe }}</h2>
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="societe" class="form-control"
                           value="{{ old('societe', $fournisseur->societe) }}" required>
                </div>
